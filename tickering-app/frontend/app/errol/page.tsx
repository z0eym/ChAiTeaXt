    ...
    <div className="flex flex-col min-h-screen w-full bg-[url('/PurpleOmbreBG.png')] bg-cover bg-center bg-no-repeat">
      ...
      <div className="flex-1 pt-32 px-10 pb-16 text-zinc-200">
        <header className="text-center mb-16">
          <h1 className="text-5xl text-white text-glow mb-4">Errol Luna</h1>
          <p className="text-xl">
        ...
        <InfoCard title="Contacts">
          <ul className="Contacts">
            <li>
               {/* EDIT "mailto:" */}
              <p>Email: <a href="mailto:elunasy02@gmail.com ?subject=Inquiry&body=" className="underline hover:text-[#ae97e7]">
               {/* EDIT THIS PLEASE. */}
                elunasy02@gmail.com</a></p></li> 
