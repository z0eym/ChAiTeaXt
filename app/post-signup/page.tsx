      ...
      <div className="flex-1 flex items-center justify-center w-full">
        <div className='bg-black/70 bg-opacity-80 p-10 rounded-xl shadow-xl max-w-md w-full flex flex-col gap-6 mt-28 text-white'>
          <div className="header">
            <div className='text-4xl text-center mb-6'>Success!</div>
            <div className='text-xl text-center mb-6'>Your account has been created successfully!</div>
          </div>
          <div className="submit-container flex flex-col ">
              <Link href="/login" className="cursor-pointer bg-[#ae97e7] py-3 rounded hover:bg-[#5e17eb] transition-colors text-center">
              Login to Start Using ChAi TeaXt</Link>
          </div>
        </div>
      </div>
