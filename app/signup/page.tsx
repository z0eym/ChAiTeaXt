  ...
  return (
    <div className="min-h-screen w-full bg-[url('/PurpleOmbreBG.png')] bg-cover bg-center bg-no-repeat flex flex-col relative items-center justify-center">
      ...
      <div className="flex-1 flex items-center justify-center w-full">
        <div className='bg-black bg-opacity-80 p-10 rounded-xl shadow-xl max-w-md w-full flex flex-col gap-6 mt-10 text-white'>
          ...
          <div className="input">Name
            <input type="text" placeholder="Enter Your Name" className="mb-5 p-3 rounded bg-white text-black focus:outline-none focus:ring-2 focus:ring-[#ae97e7] w-full"/>
          </div>
          ...
          <div className="input">Confirm Password
              <input type="password" placeholder="Confirm Your Password" className="mb-5 p-3 rounded bg-white text-black focus:outline-none focus:ring-2 focus:ring-[#ae97e7] w-full"/>
          </div>
        </div>
      

      <div className="submit-container flex flex-col ">
        <button type="submit" className="cursor-pointer bg-[#ae97e7] py-3 rounded hover:bg-[#5e17eb] transition-colors">Sign Up</button>
