...
export default function ReneePortfolio() {
    ...
    <div className="flex flex-col min-h-screen w-full bg-[url('/PurpleOmbreBG.png')] bg-cover bg-center bg-no-repeat">
      ...
      <div className="flex-1 pt-32 px-10 pb-16 text-zinc-200">
        <header className="text-center mb-16">
          <h1 className="text-5xl text-white text-glow mb-4">Renee Reyes</h1>
          <p className="text-xl">
        ...
        <InfoCard title="About Me">
          Hello, my name is Renee Reyes. I am an undergraduate student in the IT
        ...
        <InfoCard title="Contacts">
          <ul className="Contacts">
            <li>
              <p>Email: <a href="mailto:reneereyes@gmail.com" className="underline hover:text-[#ae97e7]">
                reneereyes@gmail.com</a></p>
            </li>
            <li>
              <p>GitHub: <a href="https://github.com/reneereyes" target="_blank" className="underline hover:text-[#ae97e7]">
                github.com/reneereyes
              </a></p>
            </li>
            <li>
              <p>LinkedIn: <a href="https://www.linkedin.com/in/reneereyes" target="_blank" className="underline hover:text-[#ae97e7]">
                linkedin.com/in/reneereyes
              </a></p>
            </li>
          </ul>
        </InfoCard>
