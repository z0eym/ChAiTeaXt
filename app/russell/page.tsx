      ...
      <div className="flex-1 pt-32 px-10 pb-16 text-zinc-200">
        ...
        <InfoCard title="Contacts">
          <ul className="Contacts">
            <li>
              <p>Email: <a href="mailto:russelkim@example.com" className="underline hover:text-[#ae97e7]">
                russelkim@example.com</a></p>
            </li>
            <li>
              <p>GitHub: <a href="https://github.com/russelkim" target="_blank" className="underline hover:text-[#ae97e7]">
                github.com/russelkim
              </a></p>
            </li>
            <li>
              <p>LinkedIn: <a href="https://www.linkedin.com/in/russelkim" target="_blank" className="underline hover:text-[#ae97e7]">
                linkedin.com/in/russelkim
              </a></p>
            </li>
          </ul>
        </InfoCard>
